...
public class Leapcodevalue implements Comparable<Leapcodevalue>{
	...
	/** full constructor */
	public Leapcodevalue(String id, String codetypename, String codeid, String codevalue, String codeparentid, String remarks, Integer cloudappid, String creator, Timestamp createtime, String updater, Timestamp updatetime, Integer orderid){
		this.id = id;

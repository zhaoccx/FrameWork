...
public class Leapcodetype implements java.io.Serializable {
	...
	/** full constructor */
	public Leapcodetype(String id, String parentcodetypename,
			String rootcodetypename, Integer codelevel, Integer codeleveldeep,
			String codetypename, String codetypeenname, String codetablecnname,
			String codefieldid, String valuefieldid, Integer linktype,
			Integer linkagetype, String codeparentfieldid, Integer codesize,
			String sqlexpression, String orderexpression,
			String valueexpression, String schemaname, String dbname,
			String datasource, String fromsource, String remarks,
			String leapprojectid, Integer cloudappid, String creator,
			Timestamp createtime, String updater, Timestamp updatetime,
			Integer codecount, String codegroup, String ownersys) {
		this.id = id;

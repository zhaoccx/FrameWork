...
public class Leaptable implements java.io.Serializable {
	...
	/** full constructor */
	public Leaptable(String id, String dbname, String name, String cnname,
			String enname, String code, String tabletype, String viewquery,
			String schemaname, String orderexpression, Integer gislayermode,
			String linkedlayer, Integer autoareacontrol, String remarks,
			Integer gislayertype, String gislayericon, String leapprojectid,
			Integer cloudappid, String creator, Timestamp createtime,
			String updater, Timestamp updatetime, String categoryname,
			String ownersys) {
		this.id = id;
		this.dbname = dbname;
		this.name = name;
